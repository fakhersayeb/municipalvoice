...
static Future<List<Data>> save() async {
   ...
   String url2 = 'http://10.0.2.2:8080/idf'; 
...
class fuitepage extends StatefulWidget {
  const fuitepage({ Key? key }) : super(key: key);

  @override
  _fuitepageState createState() => _fuitepageState();
}

class _fuitepageState extends State<fuitepage> {
