...
class Claim {
  ...
  List<String> fi=[];
  String date;
  Claim({ this.id,this.name,this.commentaire,this.adresse,this.fi,this.date});
...
List files=[];
 ...
 Future save() async {
    ...
    for (int i = 0; i < images.length; i++) {
        ...
        final msg = jsonEncode({'name': claim.name,'commentaire': claim.commentaire,'adresse': claim.adresse,'adr':adr,'type':6,
              'id':claim.id,'name1':name1,'name2':name2,'name3':name3,'name4':name4,'name5':name5,'name6':name6,'date':claim.date});
   try{
            ...
            alignment: Alignment.topCenter,
              ...
              SizedBox(
                ...
                width: 10,
                   ...
                   Text('Veuillez saisir le code de l’équipement défaillant',style: TextStyle(color: themeSwitch ? Colors.white : Colors.grey[850],fontSize: 15,fontWeight: FontWeight.normal),).tr(),
                  ],
                ),),
                 FadeAnimation(1.3, Row(
                  children: [
                ...
                width: 10,
                   ...
                   Text('(le code est inscrit sur l’équipement AxxxDxPxxx)',style: TextStyle(color: themeSwitch ? Colors.white : Colors.grey[850],fontSize: 15,fontWeight: FontWeight.normal),).tr(),
                  ],
                ),),
               _textValue!=''? FadeAnimation(1.1,  Container(
                ...
                child:FadeAnimation(1.1, TextFormField(
                  ...
                  child:RaisedButton(
                   ...
                   child: Text('Récuperer id',style: TextStyle(color: themeSwitch ? Colors.white : Colors.grey[850],),),
                 ),),
                 ), 
               */
                FadeAnimation(1.2, Row(
                ...
                width: 10,
                    ...
                    Text('Adresse*',style: TextStyle(color: themeSwitch ? Colors.white : Colors.grey[850],fontSize: 15,fontWeight: FontWeight.bold),).tr(),
                  ],
                ),),
                   FadeAnimation(1.4,  Container(
                                padding: EdgeInsets.all(8),
